...
#include "Particle.h"
#line 1 "c:/Users/Vikash/Downloads/Lab12Slave/src/Lab12Slave.ino"
/*
 * Project Lab12Slave
 * Description:
 * Author:
...
void setup();
void loop();
#line 7 "c:/Users/Vikash/Downloads/Lab12Slave/src/Lab12Slave.ino"
SYSTEM_MODE(MANUAL);
...
void loop()
{
  ...
  if(CS == true){
    ...
    if(rx[0] == '?'){
      ...
      tx[0] = digitalRead(D5); // change pins
      SPI1.transfer(tx, rx, 1, NULL);
